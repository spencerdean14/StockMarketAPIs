...
class MarketWidgetConfigureActivity : Activity() {
    ...
    public override fun onCreate(icicle: Bundle?) {
        ...
        appWidgetText.setText(loadTitlePref(this@MarketWidgetConfigureActivity, appWidgetId))
    }

}

private const val PREFS_NAME = "com.steele.marketapi.MarketWidget"
